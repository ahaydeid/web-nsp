...
export default function HistorySection() {
  return (
    <div id="sejarah" className="w-full py-20 px-4 mx-auto max-w-5xl text-blue-800">
      <h2 className={`${fredoka.className} text-4xl sm:text-5xl font-semibold text-center text-blue-900 relative inline-block`}>
        Sejarah NSP
      ...
      <div className="mt-14 space-y-6 text-gray-700 leading-relaxed text-base">
        <p>
